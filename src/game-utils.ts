...
export class GameUtils {
    ...
    /**
     * Loads a bow model from .obj file and adds it scene.
     * @param scene
     */
    public static createBow(scene: BABYLON.Scene): Observable<BABYLON.AbstractMesh> {
        // create a mesh object with loaded from file
    ...
    public static createSight(scene: BABYLON.Scene): Observable<BABYLON.AbstractMesh> {
        // create a mesh object with loaded from file
    ...
    public static createCrosshair(scene: BABYLON.Scene): BABYLON.Mesh {
        let crosshairMaterial = new BABYLON.StandardMaterial("crosshairMaterial", scene);
        crosshairMaterial.diffuseTexture = new BABYLON.Texture("./assets/texture/crosshair.png", scene);
        //groundMaterial.diffuseTexture.uScale = groundMaterial.diffuseTexture.vScale = 4;
        crosshairMaterial.backFaceCulling = false;
